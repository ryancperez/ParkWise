...
import com.example.parkwise.databinding.ActivityGeofenceBinding;
...
public class GeofenceActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    // geofenceID should accept user input and not hardcoded
    ...
    private void enableUserLocation() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) ==
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                // show user dialog for displaying why permission is needed
        ...
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
        {
            if (requestCode == FINE_LOCATION_ACCESS_REQUEST_CODE) {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    // what to do if you do NOT have permission
                }
            }
        }
    }
    ...
    private void tryAddingGeofence(LatLng latLng) {
        // add marker/ circle of geofence
        mMap.clear();
        addMarker(latLng);
        addCircle(latLng, GEOFENCE_RADIUS);
        // irl geofence radius should be input from user and not hardcoded
